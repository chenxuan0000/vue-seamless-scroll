<template>
  <div id="app">
    <div class="fixed top-0 w-100 z-1 flex-none flex flex-row items-center pv3 ph4 bg-blue white">
      <div class="flex-none">
        <a href="https://github.com/chenxuan0000/vue-seamless-scroll" rel="noopener" target="_blank" title="View on Github">
      ...
      <div class="flex-none" style="margin-left: 10px;">
        <a href="https://github.com/chenxuan0000/vue-seamless-scroll" class="white no-underline underline-hover">vue-seamless-scroll</a>
      </div>
    </div>
