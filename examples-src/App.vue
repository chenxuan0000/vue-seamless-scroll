<template>
    <div id="app">
        <div class="fixed top-0 w-100 z-1 flex-none flex flex-row items-center pv3 ph4 bg-blue white">
            <div class="flex-fill"><a href="https://github.com/dzwillia/vue-simple-spinner/releases/tag/v1.2.8"
                                      class="white no-underline underline-hover">vue-seamless-scroll</a></div>
            <div class="flex-none"><a href="https://github.com/dzwillia/vue-simple-spinner" rel="noopener"
