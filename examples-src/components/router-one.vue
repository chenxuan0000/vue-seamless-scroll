<template>
  <div class="router1">
    ...
    <div class="flex wd800">
      <div class="options" style="color:#357edd;">
        <p>
          <b>demo2</b> limitMoveNum过大不滚动 开启了openWatch</p>
        <p>3s后data增加到9条</p>
        var option = {<br/> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;limitMoveNum: 7<br/> }
      </div>
    ...
    <div class="flex wd800">
      <div class="options" style="color:#357edd;">
        <p>
          <b>demo3</b> limitMoveNum过大不滚动 关闭了openWatch</p>
        <p>3s后data增加到9条</p>
        var option = {<br/> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;limitMoveNum: 7<br/> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;openWatch: false<br/> }
      </div>
    ...
    <div class="flex wd800">
      <div class="options" style="color:#357edd;">
        <p>
          <b>demo4</b>手动切换的demo</p>
        var option = {<br/> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;autoPlay: false<br/> }
      </div>
      <my-class :class-option="classOption3" class="warp2 demo4">
        <span class="name" slot="left-switch" style="display: block;width: 30px;height: 40px;cursor: pointer;background-color:yellow;text-align: center;line-height:40px;">&lt;</span>
        <ul class="ul-item clearfix">
          <li class="li-item" v-for="item in listData3">{{item}}</li>
        </ul>
        <span class="name" slot="right-switch" style="display: block;width: 30px;height: 40px;cursor: pointer;background-color:yellow;text-align: center;line-height:40px;">&gt;</span>
      </my-class>
    </div>
    <div class="flex wd800">
      <div class="options" style="color:#357edd;">
        <p>
          <b>demo5</b> 向右的无缝滚动</p>
        var option = {<br/> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;limitMoveNum: 2<br/> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;direction: 3<br/> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;singleWidth: 134<br/> }
      </div>
      <my-class :data="listData4" :class-option="classOption4" class="warp2">
        <ul class="ul-item ul-item2 clearfix" :style="{width: ulItem2Width + 'px'}"> 
          <li class="li-item" v-for="item in listData4">{{item}}</li>
        </ul>
      </my-class>
    </div>
    <div class="flex wd800">
      <div class="options" style="color:#357edd;">
        <p>
          <b>demo6</b> 向左的无缝滚动 limitMoveNum过大不滚动</p>
        <p>3s后data增加到4条</p>
        var option = {<br/> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;limitMoveNum: 3<br/> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;direction: 3<br/> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;singleWidth: 134<br/> }
      </div>
      <my-class :data="listData5" :class-option="classOption5" class="warp2">
        <ul class="ul-item clearfix">
          <li class="li-item" v-for="item in listData5">{{item}}</li>
        </ul>
      </my-class>
    </div>
    <div class="flex wd800">
      <my-class :data="listData" :class-option="{step:0.5}" class="seamless-warp test">
        <div>
          <div class="item">
            <div>
